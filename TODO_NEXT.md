...
Also completed locally: one identity with membership-derived Agency/Brand workspaces, first-workspace registration choice, exact workspace switching, independent-brand team invitations, separate agency-brand partnership invitations, brand-owner billing routes/UI, canonical invitation links, and audited Platform Admin provisioning/recovery. Deployment and live-provider smoke tests remain separate release work.

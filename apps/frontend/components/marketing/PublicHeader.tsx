...
const navigation = [
  ...
  { label: "Çözümler", href: "/ajans-programi" },
...
export function PublicHeader() {
  ...
  return (
    <>
      ...
      <nav className="mx-auto max-w-7xl px-4 sm:px-6" aria-label="Ana navigasyon">
        <div className="flex h-16 items-center justify-between">
          <Link href="/" className="group flex min-h-11 items-center gap-2.5" aria-label="PostPiloter ana sayfa">
            <span

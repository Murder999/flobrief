...
def upgrade() -> None:
    ...
    op.add_column("platform_provider_settings", sa.Column("encrypted_api_key", sa.String(1000), nullable=True))
    op.add_column("platform_provider_settings", sa.Column("email_from_name", sa.String(200), nullable=True))
    op.add_column("platform_provider_settings", sa.Column("email_from_email", sa.String(200), nullable=True))
    op.add_column("platform_provider_settings", sa.Column("email_reply_to", sa.String(200), nullable=True))
    op.add_column("platform_provider_settings", sa.Column("email_api_key_masked", sa.String(30), nullable=True))

    # ── notification_deliveries — recipient_email ──────────────────────────────
    op.add_column("notification_deliveries", sa.Column("recipient_email", sa.String(255), nullable=True))

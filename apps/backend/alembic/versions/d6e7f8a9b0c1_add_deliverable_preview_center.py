...
def upgrade() -> None:
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["profile_photo_asset_id"], ["assets.id"], ondelete="SET NULL"),
    ...
    op.create_index("ix_dpc_deliverable_id", "deliverable_preview_configs", ["deliverable_id"])
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("deliverable_id", "asset_id", name="uq_dps_deliverable_asset"),
    )

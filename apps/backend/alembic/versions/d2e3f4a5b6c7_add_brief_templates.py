...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "template_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("brief_templates.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "section_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("brief_template_sections.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_unique_constraint(
        "uq_field_key_per_section", "brief_template_fields", ["section_id", "field_key"]
    )

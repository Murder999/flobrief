...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("agency_id", sa.UUID(as_uuid=True), sa.ForeignKey("agencies.id", ondelete="CASCADE"), nullable=False),
        sa.Column("brand_id", sa.UUID(as_uuid=True), sa.ForeignKey("brands.id", ondelete="CASCADE"), nullable=True),
        sa.Column("invitation_type", sa.String(20), nullable=False, server_default="agency"),
        sa.Column("email", sa.String(255), nullable=False),
        sa.Column("role", sa.String(40), nullable=False),
        sa.Column("token_hash", sa.String(128), nullable=False),
        sa.Column("invited_by", sa.UUID(as_uuid=True), sa.ForeignKey("users.id", ondelete="RESTRICT"), nullable=False),

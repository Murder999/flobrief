# Flobrief — Claude Development Guide
...
### Token Efficiency
- Start each part by reading: CLAUDE.md, PROJECT_STATE.md, TODO_NEXT.md, PART_PLAN.md
...
Issues live in GitHub Issues (`github.com/Murder999/flobrief`). See `docs/agents/issue-tracker.md`.
